  ...
  <div>
    <el-row style="height: 950px;">
      ...
      >
        ...
        <p slot="content">director：{{item.director}}</p>
        <p slot="content">editor：{{item.scriptwriter}}</p>
        <p slot="content">actor：{{item.actors}}</p>
        <p slot="content">country/region：{{item.district}}</p>
        <p slot="content">language：{{item.language}}</p>
        <p slot="content">timee：{{item.duration}}</p>
        ...
        <p slot="content" style="width: 300px" class="abstract">intro：{{item.abs}}</p>
        <el-card style="background-color:transparent;border:none;width: 135px;margin-bottom: 10px;height: 300px;float: left;margin-right: 25px" class="movie"
          ...
          <div class="title" style="padding-left: 10px;">
            <a @click="jump(item)" style="cursor:pointer">{{item.title}}</a>
